...
export default function Hero() {
    return(
        <div className="flex flex-col my-8 items-center mx-auto p-5 space-y-7 md:space-x-7 md:px-8 md:flex-row lg:px-14">
            <div className=" flex flex-col space-y-3 text-center items-center md:item-left md:w-1/2 md:items-start md:space-y-4">
                <h1 className="text-[2rem] leading-9 font-bold md:leading-12 md:text-left md:text-3xl mlg:text-5xl lg:text-5xl">
